...
import org.msdemt.demo.design.AwardReq;
import org.msdemt.demo.design.AwardRes;
import org.msdemt.demo.design.PrizeController;
        ...
        req02.setExtMap(new HashMap<String, String>(){
            {
                ...
                put("consigneeUserPhone", "123321");
                put("consigneeUserAddress", "xx省xx市xx");
            }
        });
